...
for i=1:length(fmri_block_onsets)
    ...
    filename = strcat('sub008_block', num2str(i), 'conditions.mat');
...
for i = 1:8
    block_filename = strcat('sub008_block', num2str(i), 'conditions.mat');
...
save_filename = sprintf('%s_BehavioralResults.mat', subject_id);
